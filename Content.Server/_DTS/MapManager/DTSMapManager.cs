...
public sealed class DTSMapManager : IGameMapManager, IEntityEventSubscriber
{
    ...
    public void Initialize()
    {
        ...
        _configurationManager.OnValueChanged(DTSCvars.DisableMapRepetition, value => _disableMapRepetition = value, true); // DTS-EDIT
