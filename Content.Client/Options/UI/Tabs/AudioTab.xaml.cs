    ...
    public sealed partial class AudioTab : Control
    {
        ...
        private void UpdateChanges()
        {
            ...
            var isAHelpVolumeSame =
                Math.Abs(AHelpVolumeSlider.Value - _cfg.GetCVar(CCVars.AHelpVolume) * 100f / ContentAudioSystem.AHelpMultiplier) < 0.01f;
            var isTtsVolumeSame =
                Math.Abs(LobbyVolumeSlider.Value - _cfg.GetCVar(CCVars.LobbyMusicVolume) * 100f / ContentAudioSystem.TtsMultiplier) < 0.01f;
