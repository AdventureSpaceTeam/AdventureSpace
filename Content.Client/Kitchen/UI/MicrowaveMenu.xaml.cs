    ...
    public sealed partial class MicrowaveMenu : FancyWindow
    {
        ...
        protected override void FrameUpdate(FrameEventArgs args)
        {
            ...
            if(_owner.currentState.CurrentCookTimeEnd > _owner.GetCurrentTime())
            {
                ...
                ("time",_owner.currentState.CurrentCookTimeEnd.Subtract(_owner.GetCurrentTime()).Seconds + _owner.currentState.CurrentCookTimeEnd.Subtract(_owner.GetCurrentTime()).Minutes * 60) ); 
            }
        }
    }
}
