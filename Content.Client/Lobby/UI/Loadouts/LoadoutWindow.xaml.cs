...
public sealed partial class LoadoutWindow : FancyWindow
{
    ...
    public LoadoutWindow(HumanoidCharacterProfile profile, RoleLoadout loadout, RoleLoadoutPrototype proto, ICommonSession session, IDependencyCollection collection, ISharedSponsorsManager? sponsorsManager)  // Alteros-Sponsors
    {
        ...
        else
        {
            foreach (var group in proto.Groups)
            {
                ...
                var container = new LoadoutGroupContainer(profile, loadout, protoManager.Index(group), session, collection, sponsorsManager);  // Alteros-Sponsors
