...
FORK_ID = "adventure-dts"
BUILD_URL = f"http://45.67.230.80/builds_dir/builds/{{FORK_VERSION}}/{FILE}"
MANIFEST_URL = f"http://45.67.230.80/cdn/version/{{FORK_VERSION}}/manifest"
MANIFEST_DOWNLOAD_URL = f"http://45.67.230.80/builds_dir/builds/{{FORK_VERSION}}/SS14.Client.zip"
