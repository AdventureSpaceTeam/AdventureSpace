#//ВЕСЬ ЭТОТ ФАЙЛ НУЖНО УДАЛИТЬ, ОН ПРОСТО КОПИЯ СУЩЕСТВУЮЩЕГО, НО НАХОДИТЬСЯ НЕ В ПАПКЕ ДЛЯ РУССКОЙ ЛОКАЛИЗАЦИИ//
...
ent-FoodSoupBeet = борщ
    .desc = Борщ для всех, даром, и пусть никто не уйдёт голодным.
