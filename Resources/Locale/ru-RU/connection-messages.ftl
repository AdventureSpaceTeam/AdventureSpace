...
ban-expires = Вы получили бан на { $duration } минут, и он истечёт { $time } по UTC (для москосвкого времени добавьте 3 часа) или вы можете его обжаловать тут - https://discord.gg/AdvSpace.
