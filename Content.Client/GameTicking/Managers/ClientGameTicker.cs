...
namespace Content.Client.GameTicking.Managers
{
    ...
    public sealed class ClientGameTicker : SharedGameTicker
    {
        ...
        private void RoundEnd(RoundEndMessageEvent message)
        {
            ...
            _window = new RoundEndSummaryWindow(message.GamemodeTitle, message.RoundEndText, message.RoundDuration, message.RoundId, message.AllPlayersEndInfo, message.RoundEndStats, message.StatisticEntries, _entityManager, _playerManager);
        }
    }
}
